...
func _on_select_usrdir_mouse_entered() -> void:
	text = "Set the path of your USRDIR for the PS3 version of Cyber Troopers Virtual-On. (Do this before installing mods.)"
...
func _on_unpack_mouse_entered() -> void:
	text = "Unpack all game files into a MoongatePatcher compatible package."
